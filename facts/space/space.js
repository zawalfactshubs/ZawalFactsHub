...
const generateBtn = document.getElementById('generate-space-fact');
const spaceGrid = document.getElementById('space-facts-grid');
...
const noResults = document.getElementById('space-no-results');

// ===== Load JSON =====
// JSON Location → /space/data/space.json
