...
// ===== DOM Elements =====
const factText = document.getElementById('sport-fact-text');
const generateBtn = document.getElementById('generate-sport-fact');
const sportGrid = document.getElementById('sport-facts-grid');
const shareModal = document.getElementById('share-modal');
const shareLinksContainer = document.getElementById('share-links');
const searchInput = document.getElementById('sport-search-input');
const noResults = document.getElementById('sport-no-results');

// ===== Load JSON =====
// JSON Location → /sport/data/sport.json
