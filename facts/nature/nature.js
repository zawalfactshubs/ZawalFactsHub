...
// ===== DOM Elements =====
const factText = document.getElementById('nature-fact-text');
const generateBtn = document.getElementById('generate-nature-fact');
const natureGrid = document.getElementById('nature-facts-grid');
...
const noResults = document.getElementById('nature-no-results');

// ===== Load JSON =====
fetch('data/nature.json')
  .then(res => res.json())
  .then(data => {
    facts = data;
    showRandomFact();
