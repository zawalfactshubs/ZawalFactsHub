...
// ===== DOM Elements =====
const factText = document.getElementById('worldrecord-fact-text');
const generateBtn = document.getElementById('generate-worldrecord-fact');
const worldrecordGrid = document.getElementById('worldrecord-facts-grid');
const shareModal = document.getElementById('share-modal');
const shareLinksContainer = document.getElementById('share-links');
const searchInput = document.getElementById('worldrecord-search-input');
const noResults = document.getElementById('worldrecord-no-results');

// ===== Load JSON =====
// JSON Location → /worldrecord/data/worldrecord.json
fetch('data/worldrecord.json')
  .then(res => res.json())
  .then(data => {
    facts = data;
    showRandomFact();
...
card.innerHTML = `
  ...
  📤 Share
    ...
    worldrecordGrid.appendChild(card);
  });
}
...
function downloadCard(btn) {
  ...
  image.onload = () => {
    ...
    link.download = 'worldrecord-fact.png';
    link.click();
  };
}
