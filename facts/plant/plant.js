...
// ===== DOM Elements =====
const factText = document.getElementById('plant-fact-text');
const generateBtn = document.getElementById('generate-plant-fact');
const plantGrid = document.getElementById('plant-facts-grid');
...
const noResults = document.getElementById('plant-no-results');

// ===== Load JSON =====
// JSON Location → /facts/plant/data/plants.json
