...
// ===== DOM Elements =====
const factText = document.getElementById('funweird-fact-text');
const generateBtn = document.getElementById('generate-funweird-fact');
const funweirdGrid = document.getElementById('funweird-facts-grid');
const shareModal = document.getElementById('share-modal');
const shareLinksContainer = document.getElementById('share-links');
const searchInput = document.getElementById('funweird-search-input');
const noResults = document.getElementById('funweird-no-results');

// ===== Load JSON =====
fetch('data/funweird.json')
  .then(res => res.json())
  .then(data => {
    facts = data;
    showRandomFact();
...
// ===== Share Modal (kept, but not used by button) =====
...
function downloadCard(btn) {
  ...
  image.onload = () => {
    ...
    link.download = 'funweird-fact.png';
    link.click();
  };
}
