...
// ===== DOM Elements =====
const factText = document.getElementById('psychology-fact-text');
const generateBtn = document.getElementById('generate-psychology-fact');
const psychologyGrid = document.getElementById('psychology-facts-grid');
const shareModal = document.getElementById('share-modal');
const shareLinksContainer = document.getElementById('share-links');
const searchInput = document.getElementById('psychology-search-input');
const noResults = document.getElementById('psychology-no-results');

// ===== Load JSON =====
// JSON Location → /psychology/data/psychology.json
fetch('data/psychology.json')
  .then(res => res.json())
  .then(data => {
    facts = data;
    showRandomFact();
...
function downloadCard(btn) {
  ...
  image.onload = () => {
    ...
    link.download = 'psychology-fact.png';
    link.click();
  };
}
