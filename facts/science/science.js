...
// ===== DOM Elements =====
const factText = document.getElementById('science-fact-text');
const generateBtn = document.getElementById('generate-science-fact');
const scienceGrid = document.getElementById('science-facts-grid');
...
const noResults = document.getElementById('science-no-results');

// ===== Load JSON =====
// JSON Location → /science/data/science.json
...
function downloadCard(btn) {
  ...
  image.onload = () => {
    ...
    link.download = 'science-fact.png';
    link.click();
  };
}
