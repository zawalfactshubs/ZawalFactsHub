...
// ===== DOM Elements =====
const factText = document.getElementById('history-fact-text');
const generateBtn = document.getElementById('generate-history-fact');
const historyGrid = document.getElementById('history-facts-grid');
...
function downloadCard(btn) {
  ...
  image.onload = () => {
    ...
    link.download = 'history-fact.png';
    link.click();
  };
}
