...
// ===== DOM Elements =====
const factText = document.getElementById('tech-fact-text');
const generateBtn = document.getElementById('generate-tech-fact');
const techGrid = document.getElementById('tech-facts-grid');
...
// ===== Load JSON =====
// JSON Location → /tech/data/tech.json
